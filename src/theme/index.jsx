...
// Monochromatic shades derived from #db7146
const BRAND_MAIN = '#db7146';
const BRAND_LIGHT = '#f2a077';   // tint for gradient highlight
const BRAND_DARK = '#a34a28';    // shade for gradient depth / secondary variant
const BRAND_DARKER = '#7a3720';  // deeper shade for secondary hover states

const BRAND_GRADIENT = `linear-gradient(135deg, ${BRAND_LIGHT} 0%, ${BRAND_MAIN} 55%, ${BRAND_DARK} 100%)`;
const BRAND_GRADIENT_DARK = `linear-gradient(135deg, ${BRAND_DARK} 0%, ${BRAND_DARKER} 100%)`;
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          ...
          "&:hover": {
            ...
            color: BRAND_MAIN,
            boxShadow: "0 6px 22px rgba(219,113,70,0.20)",
          },
        },
        containedSecondary: {
          background: `${BRAND_GRADIENT_DARK} padding-box, ${BRAND_GRADIENT_DARK} border-box`,
          color: "#fff",
          boxShadow: "0 4px 18px rgba(163,74,40,0.30)",
          "&:hover": {
            background: `linear-gradient(#ffffff, #ffffff) padding-box, ${BRAND_GRADIENT_DARK} border-box`,
            color: BRAND_DARK,
            boxShadow: "0 6px 22px rgba(163,74,40,0.18)",
          },
        },
        outlinedPrimary: {
          background: `linear-gradient(#ffffff, #ffffff) padding-box, ${BRAND_GRADIENT} border-box`,
        ...
        textSecondary: {
          color: BRAND_DARK,
          "&:hover": {
            background: "rgba(163,74,40,0.07)",
            transform: "translateY(0)",
          },
        },
      },
